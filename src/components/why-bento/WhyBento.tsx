...
import { whyBentoCss } from './WhyBento.styles';
...
const TileTop: React.FC<{ tile: WhyTile; big?: boolean; photo?: boolean }> = ({ tile, big, photo }) => (
...
export const WhyBento = ({
  ...
  useWhyBentoEffects(rootRef, safeTiles.length);

  return (
    <section className="wb-root" ref={rootRef}>
      <style>{whyBentoCss}</style>
