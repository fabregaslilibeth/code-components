...
const WhyBentoWebflow = ({
  ...
  return <WhyBento items={items} />;
};

export default declareComponent(WhyBentoWebflow, {
  name: 'Why Bento',
  description: 'Bento-style "why us" section with a feature tile and icon cards',
  group: 'Content',
  props: {
